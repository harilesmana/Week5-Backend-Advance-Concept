const wsUrl = window.location.origin.replace("http", "ws") + "/ws";
        ...
        const username =  document.querySelector("h1")?.textContent.replace("Welcome, ", "").trim() || "Guest";
        ...
        function displayMessage(data) {
            ...
            const msgClass = isMine ? "my-message" : "message";

            if (!msgContainer) {
                msgContainer = document.createElement("div");
                msgContainer.className = msgClass;
